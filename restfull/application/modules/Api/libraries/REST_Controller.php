...
abstract class REST_Controller extends MX_Controller {
    ...
    /**
     * Contains details about the REST restfull
    ...
    /**
     * If the request is allowed based on the restfull key provided
     *
     * @var bool
     */
    ...
    /**
     * Information about the current restfull user
     *
     * @var object
     */
    protected $_apiuser;
    ...
    /**
     * Constructor for the REST restfull
     *
     * @access public
    ...
    /**
     * See if the user has provided an restfull key
     *
     * @access protected
     * @return bool
     */
    ...
    {
        // Get the restfull key name variable set in the rest config file
    ...
    protected function _check_limit($controller_method)
    {
        ...
        switch ($this->config->item('rest_limits_method'))
        {
            ...
            case 'API_KEY':
                $limited_uri = 'restfull-key:' . $api_key;
                break;
    ...
    /**
     * Check to see if the restfull key has access to the controller and methods
     *
     * @access protected
     * @return bool TRUE the restfull key has access; otherwise, FALSE
     */
    ...
    protected function _check_cors()
    {
        ...
        // If we want to allow any domain to access the restfull
