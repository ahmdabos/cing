...
|--------------------------------------------------------------------------
|
| Set to force the use of HTTPS for REST restfull calls
|
*/
...
|--------------------------------------------------------------------------
|
| Name of the password protected REST restfull displayed on login dialogs
|
| e.g: My Secret REST restfull
|
*/
$config['rest_realm'] = 'REST restfull';
...
|--------------------------------------------------------------------------
|
| Set to specify the REST restfull requires to be logged in
|
...
/*
|--------------------------------------------------------------------------
| Allow Authentication and restfull Keys
|--------------------------------------------------------------------------
|
| Where you wish to have Basic, Digest or Session login, but also want to use restfull Keys (for limiting
...
|
| e.g: md5('admin:REST restfull:1234') = '1e957ebc35631ab22d5bd6526bd14ea2'
|
*/
...
/*
|--------------------------------------------------------------------------
| REST restfull Keys Table Name
|--------------------------------------------------------------------------
|
| The table name in your database that stores restfull keys
|
*/
...
|--------------------------------------------------------------------------
|
| When set to TRUE, the REST restfull will look for a column name called 'key'.
...
/*
|--------------------------------------------------------------------------
| REST restfull Limits method
|--------------------------------------------------------------------------
|
| Specify the method used to limit the restfull calls
|
| Available methods are :
| $config['rest_limits_method'] = 'IP_ADDRESS'; // Put a limit per ip address
| $config['rest_limits_method'] = 'API_KEY'; // Put a limit per restfull key
...
/*
|--------------------------------------------------------------------------
| REST restfull Key Variable
|--------------------------------------------------------------------------
|
| Custom header to specify the restfull key

| Note: Custom headers with the X- prefix are deprecated as of
| 2012/06/12. See RFC 6648 specification for more details
|
*/
$config['rest_key_name'] = 'X-restfull-KEY';
...
|--------------------------------------------------------------------------
|
| When set to TRUE, the REST restfull will log actions based on the column names 'key', 'date',
...
|--------------------------------------------------------------------------
| When set to TRUE, the REST restfull will check the access table to see if
| the restfull key can access that controller. 'rest_enable_keys' must be enabled
| to use this
|
| Default table schema:
|   CREATE TABLE `access` (
...
/*
|--------------------------------------------------------------------------
| REST restfull Access Table Name
|--------------------------------------------------------------------------
|
...
/*
|--------------------------------------------------------------------------
| REST restfull Param Log Format
|--------------------------------------------------------------------------
|
| When set to TRUE, the REST restfull log parameters will be stored in the database as JSON
...
|--------------------------------------------------------------------------
|
| When set to TRUE, the REST restfull will count the number of uses of each method
| by an restfull key each hour. This is a general rule that can be overridden in the
...
|
| See application/controllers/restfull/example.php for examples
*/
$config['rest_enable_limits'] = FALSE;

/*
|--------------------------------------------------------------------------
| REST restfull Limits Table Name
|--------------------------------------------------------------------------
|
...
| are hosting your restfull on a different domain from the application that
